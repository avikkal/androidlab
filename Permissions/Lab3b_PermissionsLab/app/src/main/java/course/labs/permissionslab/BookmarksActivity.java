...
public class BookmarksActivity extends Activity {
	...
	private void startGoToDangerousActivity() {
		...
		//Intent baseIntent = new Intent("course.labs.permissions.DANGEROUS_ACTIVITY");
		//PackageManager pkMgr = getPackageManager();
		//List<ResolveInfo> defActivity = pkMgr.queryIntentActivities(baseIntent, PackageManager.MATCH_DEFAULT_ONLY);
		//Boolean isPresent = defActivity.size() > 0;
		//if (isPresent){
